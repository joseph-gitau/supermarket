    ...
    <div class="rcontent">
        ...
        <?php 
			if(isset($_GET['success'])){
				$result=mysqli_query($con, "INSERT INTO product VALUES(product_id,{$_POST['cprice']},{$_POST['supplier']},'{$_POST['product_name']}',{$_POST['quantity']},'{$_POST['product_type']}',{$_POST['mprice']})");
