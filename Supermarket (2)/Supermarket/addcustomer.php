...
<div id="body">
    ...
    <div class="rcontent">
		...
		if(isset($_GET['success'])){
				...
				$result=mysqli_query($con,"INSERT INTO customer VALUES('cid','{$_POST['fname']}','{$_POST['lname']}','{$_POST['cjoindate']}',{$_POST['cmoneyspent']},'{$_POST['caddress']}',{$_POST['cmoney_spent_reset']},{$_POST['cphone']})");
