...
session_start(); 
	...
	if(isset($_POST['username'])){
		...
		//check
		$login = mysqli_query($con,"SELECT * FROM login WHERE username = '$user' AND password = '$pass'");
...
<div id="body">
	<div align="center">
    <a href='index.php'><img src="images/logo.png" width="200" height="200" alt='Logo' /></a>
